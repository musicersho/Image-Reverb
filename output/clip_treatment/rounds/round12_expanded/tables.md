...
| SteinmanHall | ceiling | metal_roof_deck | curtain_fabric |
| TunnelToHell | floor | rubber_flooring | marble |


## 與 T-33 凍結快取的差異（治療模式，僅記錄不卡關；見 HANDOFF_T38.md 地雷 B）

**範圍評估**：非預期範圍：5 張照片有差異（RacquetballCourt4, SteinmanHall, TunnelToHell, car_interior_suv, site_photo_gym），其中 4 張非 TunnelToHell（RacquetballCourt4, SteinmanHall, car_interior_suv, site_photo_gym），多半是本輪提示詞造成的漂移
...
- SteinmanHall：surfaces 與 T-33 凍結快取不同（凍結={'west': 'curtain_fabric', 'east': 'gypsum_board', 'south': 'gypsum_board', 'north': 'gypsum_board', 'floor': 'gypsum_board', 'ceiling': 'curtain_fabric'}，本次={'west': 'curtain_fabric', 'east': 'gypsum_board', 'south': 'gypsum_board', 'north': 'gypsum_board', 'floor': 'gypsum_board', 'ceiling': 'metal_roof_deck'}）
