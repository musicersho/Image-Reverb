# Round `round9` — T-38 治療輪紀錄

- status: complete
- 父輪次: round8
- 執行指令: `python scripts/t38_treatment_eval.py round9 --hypothesis 改 curtain_fabric 提示詞（PLAN.md round9，累積 round7＋round8）：鎖定 curtain_fabric→carpet/gypsum_board/glass 3 面誤判（car_interior_suv floor、restaurant ceiling、RacquetballCourt4 west），假設現有字串只講材質類別沒講外形，改法加入垂直懸掛與明顯摺痕的外形描述 --parent round8`
- 本輪假設與修改理由: 改 curtain_fabric 提示詞（PLAN.md round9，累積 round7＋round8）：鎖定 curtain_fabric→carpet/gypsum_board/glass 3 面誤判（car_interior_suv floor、restaurant ceiling、RacquetballCourt4 west），假設現有字串只講材質類別沒講外形，改法加入垂直懸掛與明顯摺痕的外形描述
...
| 項目 | 值 |
|---|---|
| code_sha256 | {"preprocess.py": "f3d1d2f820087f603ff5cde90c6a4905ec87513fd3d846440c2f79ee7f6b8352", "surfaces.py": "76a0398c9d9e6f7ab85ae00773cf00effb821647901fc197f8891aa13d24c3d0", "config.py": "c1e09da90283cb20b3a1c672f0b3150c6f6c280d6d83adeeb218b6413fc176c4"} |
