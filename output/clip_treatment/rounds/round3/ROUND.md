# Round `round3` — T-38 治療輪紀錄（歷史補寫，T-38A 步驟 4）

> 本檔由 T-38A 補寫，不是當輪執行當下產生的即時紀錄——round3 是「上一個視窗」
...
- status: complete
- 父輪次: round2（推定——逐輪覆寫的線性紀錄推定，非精確 lineage 證據）
- 執行指令: `python scripts/t38_treatment_eval.py round3`（重建的慣例格式，非逐字保留的原始指令列）
...
（`5a40148013a1198c168d97d2090811d8484a59f838b90d49e793a9e9eca6dc42`）與
...
相對 round0_baseline（31/76、4/13、9）：overall 下降、floor 下降、in-set 誤判上升
——本輪三項門檻皆未達成（overall 較 round1/round2 好轉，但仍未回到基線）。

## 與 T-33 凍結快取的差異範圍評估

非預期範圍：7 張照片有差異（RacquetballCourt4, SteinmanHall, TunnelToHell,
bathroom_tiled, car_interior_suv, site_photo_department_store,
site_photo_restaurant），其中 6 張非 TunnelToHell，多半是本輪提示詞造成的漂移
（`diff_scope_summary()` 對本輪差異集合的實際輸出，見同目錄 `tables.md` 最後一節
的完整差異清單）。
...
| 項目 | 值 |
|---|---|
| code_sha256 | {"preprocess.py": "f3d1d2f820087f603ff5cde90c6a4905ec87513fd3d846440c2f79ee7f6b8352", "surfaces.py": "5a40148013a1198c168d97d2090811d8484a59f838b90d49e793a9e9eca6dc42", "config.py": "c1e09da90283cb20b3a1c672f0b3150c6f6c280d6d83adeeb218b6413fc176c4"} |
