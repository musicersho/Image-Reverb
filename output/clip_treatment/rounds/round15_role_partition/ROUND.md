# Round `round15_role_partition` — T-44 role-aware 分區輪紀錄

- status: complete
- 父輪次: round11_remap_baseline
- 執行指令: `python scripts/t44_role_eval.py round15_role_partition --role-sensitivity`
- 本輪假設與修改理由: T-44 首輪：對 round11_remap_baseline 套用 PLAN_T44.md §1 的 role-aware 分區表（floor/ceiling/wall 各自候選子集，OOD 三角色皆保留），字串與門檻不動
...
overall 29/76 （下降 相對 30）；floor 5/13 （上升 相對 4）；in-set 誤判 15 （上升 相對 9）。
...
| 項目 | 值 |
|---|---|
| code_sha256 | {"preprocess.py": "f3d1d2f820087f603ff5cde90c6a4905ec87513fd3d846440c2f79ee7f6b8352", "surfaces.py": "0295b2069cccfc65a350a2af67f4df92c6463dea818568b8b3ef479fc67d3628", "config.py": "c1e09da90283cb20b3a1c672f0b3150c6f6c280d6d83adeeb218b6413fc176c4"} |
...
| clip_threshold | 0.4 |
| eval_mode | t44_role_aware:round15_role_partition |
