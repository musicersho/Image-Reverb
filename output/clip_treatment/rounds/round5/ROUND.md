# Round `round5` — T-38 治療輪紀錄（歷史補寫，T-38A 步驟 4）

> 本檔由 T-38A 補寫，不是當輪執行當下產生的即時紀錄——round5 是「上一個視窗」
...
- status: complete
- 父輪次: round4（推定——逐輪覆寫的線性紀錄推定，非精確 lineage 證據）
- 執行指令: `python scripts/t38_treatment_eval.py round5`（重建的慣例格式，非逐字保留的原始指令列）
...
（`f362aca0ed1a1fae09146b43cb0463c6fe1f04881ec63d2bb07db4894388d206`）與
...
——本輪三項門檻皆未達成，是六輪中數字並列最差的一輪之一。

## 與 T-33 凍結快取的差異範圍評估

非預期範圍：7 張照片有差異（CathedralRoom, DivorceBeach, SteinmanHall,
TunnelToHell, bathroom_tiled, bedroom_ai_generated, stairwell_tiled），其中 6 張非
...
| 項目 | 值 |
|---|---|
| code_sha256 | {"preprocess.py": "f3d1d2f820087f603ff5cde90c6a4905ec87513fd3d846440c2f79ee7f6b8352", "surfaces.py": "f362aca0ed1a1fae09146b43cb0463c6fe1f04881ec63d2bb07db4894388d206", "config.py": "c1e09da90283cb20b3a1c672f0b3150c6f6c280d6d83adeeb218b6413fc176c4"} |
