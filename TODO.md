...
- [ ] **T-47** 🟠 工程退回（Opus 第二輪複驗 2026-09-14，對象 `5d1569c`）——**Sonnet 不需再修量測**：
...
- [ ] **T-51** T-47 §8 資料集 manifest 程式計算＋回填（微型卡；裁決 T-47-M 執行卡；`src`／`scripts`／`data` 零改動；
      卡內 heredoc 指令逐字跑、`git add -f` manifest、commit 只准五檔）
