...
- [ ] **Phase 1：MVP（照片 → IR 匯出）** — T-10 ✅ / T-11 ✅ / T-12 ✅ / T-13 ✅ /
      ...
      **← 現在該做的：使用者試聽 3 個 listen_T14_* 檔 → 開 Opus 視窗驗證 T-14**
...
- [ ] 🎧 **試聽 T-14 的 3 個檔案**（T-14 卡步驟 5 必要條件）：
      `afplay output/listen_T14_small_carpet.wav`（地毯小房間，應無鐵筒子聲）、
      `afplay output/listen_T14_hall.wav`（音樂廳長殘響）、
      `afplay output/listen_T14_hall_T01baseline.wav`（T-01 對照，不得明顯劣化）
