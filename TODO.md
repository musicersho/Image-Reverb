...
- **T-17 MVP 驗收**：工程已驗證｜MVP **FAIL**（盲聽 2/5、自動組 0/8、手動組 0/5）→ 重驗 T-17-R2
  ...
  → **2026-09-18 前置追加 T-57 🟠 工程退回（Opus 2026-09-18；R1～R5 待修正輪，分母口徑交 Fable）**；**T-58 🔵 待審（Sonnet 2026-09-18 完成四基準對照，等 Opus 驗證；H1 不支持／H2 支持／H3 不支持／H4 部分支持，只量不改，不影響 R2 排程）**。
