...
- [ ] **T-55** T-11 域外出口 v3 重驗——**🔵 待審（2026-09-15：14 張＋V5 情境全部跑完，結果 PASS，21 支測試全過、六條 IR MD5 全中，自我檢查全過）→ 下一步＝開 Opus 視窗驗證**。原文：**T-55** T-11 域外出口 v3 重驗（Sonnet；14 張＋V5；等 T-54 ✅＋使用者核准 CRITERIA_T11_v3；`src/` 零改動；T-17-R2 前置）
