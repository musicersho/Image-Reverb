...
- [ ] **Phase 1：MVP（照片 → IR 匯出）** — T-10 ✅ / T-12 ✅（Opus 驗證通過 2026-08-25）/
      ...
      **T-13 🔵 待 Opus 驗證**（並行視窗完成 2026-08-26）**← 現在該做的：兩卡各開 Opus 驗證**
...
- [x] **T-13 聲學參數計算（Sabine/Eyring 逐頻段 RT60 + pre-delay）🔵 Sonnet 完成，待 Opus 驗證**
      — 約束 B（禁止平均 α）與地雷 #14（公式值≠實測，`rt60_disclaimer`）落地，
      迴歸自檢 6 個數字全部 ±10% 內通過
