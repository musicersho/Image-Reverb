...
- [ ] **Phase 1.5：場景描述與複合場景（2026-08-27 使用者需求新增）** —
      **T-20 ✅**（Opus 驗證 2026-08-28）/ **T-21 🟡 進行中**（修正輪程式與文件
      已完成 2026-08-28：閉環比對警示接上、「尺寸無關」斷言更正、v4 重生——
      ...
      **← 現在該做的：🎧 使用者重聽 v4 兩檔
      （`output/listen_coupled_stadium_corridor.wav`、
      `output/listen_coupled_neighbor_voices.wav`）→ 確認後 T-21 改 🔵 待驗證
      → 開 Opus 視窗複驗 T-21**
