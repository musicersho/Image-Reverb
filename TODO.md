...
- [ ] **T-56** T-12 v2-b 量測方法 v3——**⬜ 現在開跑（Fable 排程 2026-09-15：T-17-R2 等使用者期間的填充卡；須在 R2 樣本產生前結案）**。原文：**T-56** T-12 v2-b 量測方法 v3——**⬜ 可開跑（2026-09-15：使用者核准、守門條款刪，criteria `4a0b23e`；停滯期填充）**。原文：**T-56** T-12 v2-b 量測方法 v3（Sonnet；seed 鎖定＋10 次中位數；等使用者核准 CRITERIA_T12_v3〔含★守門條款留刪〕；停滯期填充卡，不進關鍵路徑）
