...
- **2026-09-21 🟡 Sonnet：T-70 步驟 0～2 完成（調查表 `assets/reference_rooms_heldout/SURVEY.md`）——停在「等使用者回『可以下載〈哪些〉』」**。四軸＝工程：進行中（停點）｜實驗：不適用｜產品：不適用｜MVP：不適用。五條件確認符合＝2 個（SoundCam 實驗室、會議室）；待下載確認照片＝4 個（BUT L207／L212／R112／C236）；連同 `mit_gym` 名單 3～7 個。步驟 3 另需 T-63 r1 V2-2(a) 經 Opus 審過。
