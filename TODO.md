...
- **T-44 role-aware**：工程 🟠 **退回**（Opus 第二輪複驗，2026-09-07：§7 與表 7'
  已確認逐位元一致、第一輪阻擋解除，但本輪新增的 §5「同型近失」末句稱 bedroom floor
  是離門檻最近的一面，與同報告 §7 wall 表 0.35→7 面矛盾——實際最近者為
  SteinmanHall.north 0.3941，距門檻僅 0.0059）｜實驗相對正向｜產品 🧪 **暫停採用**
