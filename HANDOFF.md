...
> 最後更新：2026-08-16（Fable 視窗，T-08 完成）｜對應 commit：`T-08:` 開頭的那個
> **新視窗請先讀 [CLAUDE.md](CLAUDE.md) 知道自己的角色，再讀本檔知道現在的狀況。**
>
> 驗證本檔是否過期：`git log --oneline -1`。若 HEAD 的訊息不是 `T-08:` 開頭，
...
Phase 1 的 T-10~T-17 已細化到可執行。

**下一步：換 Sonnet 做 T-10（專案骨架與影像前處理）。** T-10 完成後，T-11 與 T-12 可並行。
...
| T-10 | 專案骨架與影像前處理（含環景投影） | ⬜ **下一步，Sonnet 做** |
| T-11~T-17 | Phase 1 其餘任務（已細化） | ⬜ T-11/T-12 可在 T-10 後並行 |
