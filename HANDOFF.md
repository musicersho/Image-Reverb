...
🎯 **現在該做的：開 Opus 視窗依序驗證 T-14 → T-20 → T-21（T-20/T-21 建立在
T-14 引擎上，先驗地基；Prompt 在 §7，任務編號換掉即可）。**
使用者試聽全部完成：T-14 ✅「目前聽起來 OK」｜T-20 ✅「沒有問題」｜
T-21 ✅「確認OK」（三輪迭代：v1 乾聲混入/場景平衡 → v2 巨蛋尾太長/低頻共振 →
v3 滿場巨蛋＋eq_db 調音後通過）。人耳回饋全文與修正記在 TASKS.md T-21 卡。
